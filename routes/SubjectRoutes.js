...
router.route('/courseOutcomes').post(authenticate,SubjectController.addCourseOutcomes);
router.route('/courseOutcomes').get(authenticate,SubjectController.getCourseOutcomes);
