...
router.route('/question').post(authenticate,QuestionPaperController.addQuestions);
// router.route('/question').get(authenticate,QuestionPaperController.getQuestions);
router.route('/question').delete(authenticate,QuestionPaperController.removeQuestions);
router.route('/generateQuestionPaper').get(authenticate,QuestionPaperController.generateQuestionPaper);
