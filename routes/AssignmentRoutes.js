...
router
    .route("/question")
    .delete(authenticate, AssignmentController.removeQuestions);
router
    .route("/generateAssignment")
    .get(authenticate, AssignmentController.generateAssignment);
router
    .route("/postToInfoconnect")
    .get(authenticate, AssignmentController.uploadAssignment);
